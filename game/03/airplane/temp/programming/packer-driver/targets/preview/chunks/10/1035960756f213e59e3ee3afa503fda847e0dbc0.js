    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && SelfPlane === void 0 ? (_reportPossibleCrUseOfSelfPlane({
        ...
        createPlayerBulletM() {
          ...
          var pos = this.playerPlane.node.position;
        ...
        createPlayerBulletH() {
          var pos = this.playerPlane.node.position; // left
        ...
        createPlayerBulletS() {
          var pos = this.playerPlane.node.position; // middle
        ...
        createEnemyBullet(targetPos) {
          ...
          var colliderComp = bullet.getComponent(BoxCollider);
