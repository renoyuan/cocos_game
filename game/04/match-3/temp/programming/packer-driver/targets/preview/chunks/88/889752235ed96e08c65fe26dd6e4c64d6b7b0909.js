    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Button), _dec4 = property(AudioSource), _dec(_class = (_class2 = class GameController extends Component {
        ...
        onLoad() {
          ...
          // init gamemodel
          var gameModel = new (_crd && GameModel === void 0 ? (_reportPossibleCrUseOfGameModel({
            error: Error()
          }), GameModel) : GameModel)();
          gameModel.init(4);
          var gridScript = this.grid.getComponent("GridView"); // gridScript.setController(this); // 传入setController 节点
