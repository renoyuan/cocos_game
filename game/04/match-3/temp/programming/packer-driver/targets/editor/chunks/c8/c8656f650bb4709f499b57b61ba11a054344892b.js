System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "faa04tCk2hJJ5p5UFTLCuvD", "CellView", undefined);
      ...
      _export("GridView", GridView = (_dec = ccclass('GridView'), _dec2 = property(SpriteFrame), _dec3 = property(Animation), _dec(_class = (_class2 = class GridView extends Component {
        ...
        initWithModel(model) {
          let x = (_crd && CELL_WIDTH === void 0 ? (_reportPossibleCrUseOfCELL_WIDTH({
            error: Error()
          }), CELL_WIDTH) : CELL_WIDTH) * (model.startX - 0.5);
          let y = (_crd && CELL_HEIGHT === void 0 ? (_reportPossibleCrUseOfCELL_HEIGHT({
            error: Error()
        ...
        updateView(model) {
          ...
          for (var i in cmd) {
            ...
            if (cmd[i].action == "moveTo") {
              let x = (cmd[i].pos.x - 0.5) * (_crd && CELL_WIDTH === void 0 ? (_reportPossibleCrUseOfCELL_WIDTH({
                error: Error()
              }), CELL_WIDTH) : CELL_WIDTH);
              let y = (cmd[i].pos.y - 0.5) * (_crd && CELL_HEIGHT === void 0 ? (_reportPossibleCrUseOfCELL_HEIGHT({
                error: Error()
              }), CELL_HEIGHT) : CELL_HEIGHT);
              var move = cc.moveTo((_crd && ANITIME === void 0 ? (_reportPossibleCrUseOfANITIME({
                error: Error()
              }), ANITIME) : ANITIME).TOUCH_MOVE, cc.v2(x, y));
              actionArray.push(move);
            } else if (cmd[i].action == "toDie") {
              if (this.status == (_crd && CELL_STATUS === void 0 ? (_reportPossibleCrUseOfCELL_STATUS({
                error: Error()
...
//# sourceMappingURL=c8656f650bb4709f499b57b61ba11a054344892b.js.map