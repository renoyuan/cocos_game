    ...
    execute: function () {
      ...
      _cjsLoader.define(__cjsMetaURL, function (exports, require, module, __filename, __dirname) {
        ...
        function Toast(text = "", {
          ...
          let bgNode = new cc.Node(); // Lable文本格式设置
          ...
          let action = cc.sequence(cc.moveBy(duration, cc.v2(0, 0)), cc.fadeOut(0.3), finished);
...
//# sourceMappingURL=12ddea2232a4de071e4ce5e314136d75531645af.js.map